...
```sh
  ...
  git clone https://github.com/PNdunguMaina/rubis_project_app.git
```
-
...
Feel free to check the [issues page](https://github.com/PNdunguMaina/rubis_project_app/issues).
